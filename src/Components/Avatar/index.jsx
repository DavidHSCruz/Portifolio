...
export const Avatar = () => {
    ...
    function enterAnimate() {
        ...
        defaultTl.current.to(avatarRef.current, { y: 0, duration: 1, onComplete: defaultAnimate }, '<+1')
    }
    ...
    function defaultAnimate() {
        ...
        .to('.head', {x: 0, y: 0, duration: .5}, '<')
        .to('.eyebrowLeft, .eyebrowRight', { y: 15, duration: .2}, '<+1')
        .to('.eyelidTop', { y: 10, duration: .1}, '<')
        .to('.eyelidBottom', { y: -10, duration: .1, onStart: setLookAt({ x: 840, y: 320 }) }, '<')
    ...
    function surpriseAnimate() {
        ...
        surpriseTl.current.to('.eyeRight, .eyeLeft', { scaleX: 1.3, scaleY: 1.3, duration: .05 })
        ...
        .to('.neck', { rotate: boxAvatarCenterX / 80, y: 20, duration: .05 }, '<')
    ...
    useEffect(() => {
        ...
        function headMouseAnimate(clientX, clientY) {
            ...
            //orelhas
                ...
                //esquerdaX
                gsap.to('.earLeftPosition', { x: dx >= 0 ? dx/3 : -dx/2 })
                //direitaX
                gsap.to('.earRightPosition', { x: dx <= 0 ? dx/3 : -dx/2 })
            //nariz
            gsap.to('.nosePosition', { x: dx/1.2, y: dy/1.2 })
            //olhos
            
            gsap.to('.eyelidBottom', { y: 0, duration: .5})
                                ...
                                <g className="headPosition">
                                    <g className="head">
                                        ...
                                        <g id="mouth">
                                            ...
                                            <mask id="mask0_2_16" style={{maskType: "alpha"}} maskUnits="userSpaceOnUse" x="40" y="152" width="220" height="171">
                                                <g className='mouthPosition'>
